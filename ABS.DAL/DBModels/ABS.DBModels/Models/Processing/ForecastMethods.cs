...
namespace ABS.DBModels.Processing
{
    public class ForecastMethods
    {
        public string Forecast_budgetversion_id { get; set; }
        ...
        public string forecast_budgetversion_scenario_type_Code { get; set; }
        ...
        public IEnumerable<ForecastSection> Forecastsections { get; set; }
    }
