...
namespace ABS.DBModels.Models.ContextClasses
{
    public class GLContextClass
    {
        ...
        public GLAccounts GLAccount { get; }
        ...
        public GLContextClass(decimal? april, decimal? august, BudgetVersions budgetVersion, int statisticID, DataScenario dataScenarioDataID, ItemTypes dataScenarioTypeID, decimal? december, Departments department, Entities entity, Dimensions dimensionsRowID, decimal? february, Guid? identifier, bool? isActive, bool? isDeleted, decimal? january, GLAccounts gLAccount, decimal? july, decimal? june, decimal? march, decimal? may, decimal? november, decimal? october, decimal? rowTotal, byte[] rowVersion, decimal? september, TimePeriods timePeriodID, int? updateBy, DateTime? updatedDate, int? createdBy, DateTime? creationDate)
        {
            April = april;
            August = august;
        ...
        {
            return obj is GLContextClass other &&
                   April == other.April &&
                   August == other.August &&
                   ...
                   EqualityComparer<GLAccounts>.Default.Equals(GLAccount, other.GLAccount) &&
                   July == other.July &&
                   June == other.June &&
                   March == other.March &&
                   May == other.May &&
