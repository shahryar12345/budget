...
namespace ABSDAL.DataCache
{
    public class opRedisCache
    {
        ...
        public async Task SaveAllDataToCache<T>(string key, ABSDAL.Context.BudgetingContext _budgetingContext, int expirationinSeconds) where T : class
        {
        ...
        public async Task<IEnumerable<T>> LoadDataFromDB<T>( ABSDAL.Context.BudgetingContext _budgetingContext) where T : class
        {
        ...
        public async Task<IEnumerable<T>> refreshKeyData<T>(string keyName, ABSDAL.Context.BudgetingContext _budgetContext, int expirationinSeconds ) where T : class
        {
