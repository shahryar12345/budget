`NOTE: This file was copied from https://github.com/zeatful/liquibase to ensure there is also a reference if that repository becomes unavailable.  Reference the above live document for the latest updates`
